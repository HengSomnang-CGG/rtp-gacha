        ...
        >
            ...
            >
                ...
                <div className="mt-6 flex space-x-2">
                    <Link to={"https://urlshortenertool.com/RTP-RM"} className=" p-[1px] rounded bg-borderJackpot" target="_blank" rel="noopener noreferrer">
            ...
            <div>
                {list.map((item, index) => (
                    <div key={index} className="flex items-center py-2 px-7 hover:bg-[#2E2E2E] cursor-pointer">
                        <Link to={item.url} className="flex items-center text-white" target="_blank" rel="noopener noreferrer">
